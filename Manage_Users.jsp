		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                    <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>View & Authorize Users</strong></h2>
                                    <table style="margin-top: 20px;;margin-left: 20%; width: 80%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="dataset/<%=r.getString("profile_pic")%>" alt="" style="width: 50px; height: 30px; padding: 5px;"></td>
                                            ...
                                            %>
                                            <td><a href="Authorize_Users.jsp?userid=<%=r.getString("user_id")%>&&username=<%=r.getString("username")%>">Authorize</a></td>
                                        </tr>
                                        <%}}%>
                                    </table>
			  	</div>
