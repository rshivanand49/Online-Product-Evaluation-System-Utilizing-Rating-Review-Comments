...
<html>
    ...
    <body>
        ...
        <%
            ...
            PreparedStatement query=con.prepareStatement("truncate table positive_reviews"); 
            ...
            query=con.prepareStatement("select * from add_product group by cat"); 
            rs=query.executeQuery();
            ...
            while(rs.next())
            {
                ...
                String Reviews=rs.getString("feedback");
                int poss=0,neg=0;
                ...
                if(P)
                {
                    PreparedStatement c=con.prepareStatement("insert into positive_reviews(product,category,reviews) values('"+Product+"','"+Category+"','"+Reviews+"') ");
                    c.executeUpdate();
                    System.out.println(c);
                }
                ...
                {
                    PreparedStatement c=con.prepareStatement("insert into Negative_Reviews(product,category,reviews) values('"+Product+"','"+Category+"','"+Reviews+"') ");
                    c.executeUpdate();
                    System.out.println(c);
                }
                ...
                {
                    PreparedStatement c=con.prepareStatement("insert into Neutral_Reviews(product,category,reviews) values('"+Product+"','"+Category+"','"+Reviews+"') ");
                    c.executeUpdate();
                    System.out.println(c);
                }
            }//While Loop Ending
...
<!--View Ranking Classification-->
        <%
            ...
            System.out.println(geting);
                ...
                PreparedStatement geting=con.prepareStatement("insert into ranking (product,positive,negative,neutral)values('"+rs.getString("product")+"','"+Pss+"','"+Ng+"','"+Nu+"')");
