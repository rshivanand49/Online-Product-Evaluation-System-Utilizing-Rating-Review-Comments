...
<html>
    ...
    <%
            ...
            for(int i=0;i<word.length;i++)
                {
                PreparedStatement query1=con.prepareStatement("select * from positive where gud='"+word[i]+"'  ");
               System.out.println(query1);
                ...
                if(rs1.next())
                {
                           ...
                           <td><label style="color:red"><%out.print(word[i]); %></label></td>
                            ...
                            <%
                      PreparedStatement query4=con.prepareStatement("update recommend set status='Postive' where sno='"+rs.getString("sno")+"'");
