		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
                                   <h2 style="color:darkcyan;font-size: 25px;letter-spacing: 0.3px; margin-top: 10%;margin-left: 40%; "><strong>Search Products</strong></h2>
                                   <div style="margin-left:30%;">
                                   <form action="Search_Product_Action.jsp">
                                       <label style="font-size:15px; color:darkred; padding-right: 20px;"><strong>Search & View Friends</strong></label>
                                       <select name="search" placeholder="Search by category" style="color:black;">
                                           <option selected="" disabled="">Choose One</option>
                                           <%
                                           Connection con=new DB().Connect();
                                           PreparedStatement p=con.prepareStatement("SELECT * FROM category GROUP BY category_name");
